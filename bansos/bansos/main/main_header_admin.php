...
<div class="collapse navbar-collapse" id="basicExampleNav">
  ...
  <ul class="navbar-nav mr-auto">
    <li class="nav-item ">
      <a class="nav-link" href="../index/idx_halaman_awal_admin.php">Rumah
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../index/idx_halaman_awal_admin.php?penerima" class="penerima">Penerima BanSos</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../index/idx_halaman_awal_admin.php?pemohon" class="pemohon">Pemohonan Penerima BanSos</a>
    </li>
    <li class="nav-item">
